...
class ExpressServer {
    ...
    setupMiddleware() {
      ...
      this.app.get('/', (req, res) => res.sendFile(path.join(__dirname,'html','viewpost.html')));
			...
			this.app.get('/table', (req, res) => res.sendFile(path.join(__dirname,'html','table.html')));
			this.app.get('/table/:id', (req, res) => res.sendFile(path.join(__dirname,'html','table.html')));
			this.app.get('/viewproduct', (req, res) => res.sendFile(path.join(__dirname,'html','viewproduct.html')));
			this.app.get('/viewproduct/:id', (req, res) => res.sendFile(path.join(__dirname,'html','viewproduct.html')));
